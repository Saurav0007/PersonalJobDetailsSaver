...
<?php include 'registerProcess.php' ?>
				<form class="login100-form validate-form" method="POST" action="registerProcess.php">
					<span class="login100-form-title">
						User Registration
					</span>
                    <div class="wrap-input100 validate-input" data-validate = "Username is taken">
					...
					<div class="text-center p-t-136" style="right: 80%">
